...
if __name__ == "__main__":
    ...
    for file_name in file_names:
        ...
        if target is None or xpos is None or ypos is None:
            continue
        spectrum_file_name = os.path.join(args.output_directory, tag.replace('.fits', '_spectrum.fits'))
        ...
        sim_file_name = os.path.join(args.output_directory, tag.replace('reduc_', 'sim_'))
