...
def ProcessSimulationaer(airmass_num, pwv_num, oz_num, wl0_num, tau0_num):
    ...
    for atmosphere in theatmospheres:
        ...
        BaseFilename = BaseFilename_part1 + atmkey + '_' + Proc + '_' + Mod + '_z' + str(
            amfileindex) + '_' + WVXX + str(wvfileindex) + '_' + OZXX + str(ozfileindex) + '_' + AEXX + str(aer_index)
...
def ProcessSimulationaer2(airmass_num, pwv_num, oz_num, alpha_num, beta_num):
    ...
    for atmosphere in theatmospheres:
        ...
        BaseFilename = BaseFilename_part1 + atmkey + '_' + Proc + '_' + Mod + '_z' + str(
            amfileindex) + '_' + WVXX + str(wvfileindex) + '_' + OZXX + str(ozfileindex) + '_' + AEXX2 + str(aer_index)
...
if __name__ == "__main__":
    ...
    # -------------------
        ...
        try:
            ...
            print(' Exception bad getopt with :: ' + sys.argv[
                0] + ' -z <airmass> -w <pwv> -o <oz> -l <wl0_aer> -t <tau0_aer>')
            sys.exit(2)
